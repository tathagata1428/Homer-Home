...
(function(){
  ...
  function syncVoiceUi(){
    ...
    voiceBtn.title = !supported
      ? 'Voice input requires built-in browser speech recognition'
  ...
  function startVoiceInput(){
    if(!SpeechRecognitionCtor){
      setUploadStatus('This browser does not expose built-in speech recognition for the mic button.', 'warn', true);
      syncVoiceUi();
      return;
    }
    if(streaming){
