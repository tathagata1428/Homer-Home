...
(function(){
  ...
  function refreshJoeyBundleFromRedis(opts){
    ...
    return joeyFetchJson(joeyActionUrl('bundle', pass, opts.mode || currentContextMode), { cache:'no-store' }).then(function(data){
  ...
  function maybeRefreshJoeyBundleFromRedis(opts){
    ...
    return joeyFetchJson(joeyActionUrl('sync-meta', pass, opts.mode || currentContextMode), { cache:'no-store' }).then(function(data){
