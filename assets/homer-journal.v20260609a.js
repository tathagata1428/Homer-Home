...
(function () {
  ...
  var CSS = `
    ...
    .jn-db-title { font-size:1.35rem; font-weight:700; color:#e5e7eb; margin:0 0 3px; letter-spacing:-.01em; line-height:1.2; }
    .jn-db-meta { font-size:.75rem; color:rgba(148,163,184,.45); display:flex; align-items:center; gap:6px; }
    ...
    /* ── Buttons ─────────────────────────────────────────────────────*/
    .jn-btn-ghost { padding:5px 10px; border-radius:8px; border:1px solid rgba(34,197,94,.3); background:rgba(34,197,94,.07); color:rgba(34,197,94,.75); font-size:.75rem; cursor:pointer; font-family:inherit; display:flex; align-items:center; gap:4px; line-height:1.4; }
    .jn-btn-ghost:hover { background:rgba(34,197,94,.14); color:#22c55e; }
    .jn-btn-primary { padding:5px 14px; border-radius:8px; border:none; background:linear-gradient(135deg,#22c55e,#60a5fa); color:#fff; font-size:.75rem; font-weight:700; cursor:pointer; font-family:inherit; display:flex; align-items:center; gap:5px; line-height:1.4; letter-spacing:.04em; }
    ...
    .jn-week-lbl { font-size:.58rem; color:rgba(148,163,184,.35); text-transform:uppercase; letter-spacing:.05em; font-weight:600; }
    .jn-week-lbl.today { color:#22c55e; }
    ...
    .jn-week-dot.has-entry { background:rgba(34,197,94,.18); }
    .jn-week-dot.is-today { outline:2px solid rgba(34,197,94,.5); outline-offset:1px; }
    .jn-week-dot.is-today.has-entry { background:rgba(34,197,94,.15); outline-color:#22c55e; }
    .jn-week-empty { width:7px; height:7px; border-radius:50%; background:rgba(255,255,255,.12); }

    /* ── Prompt callout ──────────────────────────────────────────────*/
    .jn-callout { margin:10px 16px; border-radius:8px; background:rgba(34,197,94,.07); border-left:3px solid rgba(34,197,94,.6); padding:11px 14px; display:flex; align-items:flex-start; gap:10px; }
    .jn-callout-icon { font-size:1rem; flex-shrink:0; margin-top:2px; }
    .jn-callout-content { flex:1; min-width:0; }
    .jn-callout-lbl { font-size:.6rem; font-weight:700; text-transform:uppercase; letter-spacing:.1em; color:rgba(34,197,94,.7); margin-bottom:3px; }
    .jn-callout-text { font-size:.85rem; color:rgba(148,163,184,.85); line-height:1.5; margin-bottom:8px; font-style:italic; }
    .jn-callout-btn { padding:4px 10px; border-radius:8px; border:none; background:linear-gradient(135deg,#22c55e,#60a5fa); color:#fff; font-size:.72rem; font-weight:700; cursor:pointer; font-family:inherit; letter-spacing:.04em; }
    .jn-callout-btn:hover { filter:brightness(1.12); }
    .jn-callout-refresh { background:none; border:none; color:rgba(34,197,94,.45); font-size:1rem; cursor:pointer; padding:2px 6px; border-radius:4px; flex-shrink:0; align-self:flex-start; line-height:1; }
    .jn-callout-refresh:hover { background:rgba(34,197,94,.1); color:#22c55e; }
    ...
    .jn-group-count { font-size:.65rem; color:rgba(148,163,184,.3); background:rgba(255,255,255,.05); border-radius:3px; padding:1px 5px; }
    ...
    .jn-row-title { font-size:.875rem; font-weight:500; color:#e5e7eb; line-height:1.35; display:flex; align-items:center; gap:5px; }
    .jn-row-today-badge { font-size:.58rem; color:#22c55e; background:rgba(34,197,94,.12); border-radius:3px; padding:1px 5px; font-weight:700; flex-shrink:0; }
    .jn-row-excerpt { font-size:.75rem; color:rgba(148,163,184,.38); white-space:nowrap; overflow:hidden; text-overflow:ellipsis; line-height:1.3; margin-top:1px; }
    .jn-row-props { display:flex; align-items:center; gap:4px; flex-shrink:0; }
    .jn-tag { font-size:.65rem; color:rgba(148,163,184,.4); background:rgba(255,255,255,.06); border-radius:3px; padding:2px 6px; white-space:nowrap; }
    .jn-tag.ai { background:rgba(34,197,94,.1); color:rgba(34,197,94,.85); }
    .jn-row-del { background:none; border:none; color:rgba(148,163,184,.18); cursor:pointer; font-size:.8rem; padding:3px 6px; border-radius:4px; opacity:0; transition:opacity .1s,color .1s,background .1s; line-height:1; flex-shrink:0; }
    .jn-row:hover .jn-row-del { opacity:1; }
    .jn-row-del:hover { color:#60a5fa; background:rgba(96,165,250,.12); }

    .jn-new-row { display:flex; align-items:center; gap:8px; padding:4px 14px 4px 16px; color:rgba(148,163,184,.25); font-size:.8rem; cursor:pointer; transition:background .08s; min-height:32px; margin-top:2px; }
    .jn-new-row:hover { background:rgba(255,255,255,.03); color:rgba(34,197,94,.6); }
    ...
    .jn-empty-title { font-size:.85rem; font-weight:600; color:rgba(148,163,184,.38); margin-bottom:5px; }
    .jn-empty-sub { font-size:.75rem; color:rgba(148,163,184,.25); }

    /* ── Editor overlay ──────────────────────────────────────────────*/
    #jn-editor-overlay {
      position:fixed; inset:0; z-index:11000; background:linear-gradient(160deg,#0f172a,#050b16);
    ...
    .jn-ed-wc-badge { font-size:.7rem; color:rgba(148,163,184,.3); }
    .jn-ed-del-btn { background:none; border:none; color:rgba(148,163,184,.28); cursor:pointer; font-size:.9rem; padding:5px 7px; border-radius:4px; line-height:1; }
    .jn-ed-del-btn:hover { color:#60a5fa; background:rgba(96,165,250,.1); }
    .jn-ed-save-btn { padding:5px 14px; border-radius:8px; border:none; background:linear-gradient(135deg,#22c55e,#60a5fa); color:#fff; font-size:.75rem; font-weight:700; cursor:pointer; font-family:inherit; letter-spacing:.04em; }
    ...
    .jn-ed-date-display { font-size:1.75rem; font-weight:700; color:#e5e7eb; line-height:1.2; letter-spacing:-.02em; cursor:pointer; padding:2px 4px; border-radius:4px; display:inline-block; }
    ...
    .jn-ed-date-hint { font-size:.68rem; color:rgba(148,163,184,.3); margin-top:3px; }
    ...
    .jn-prop-key { font-size:.75rem; color:rgba(148,163,184,.35); width:72px; flex-shrink:0; padding-top:6px; font-weight:500; }
    .jn-prop-val { flex:1; }
    ...
    .jn-mood-btn.selected { background:rgba(34,197,94,.12); border-color:rgba(34,197,94,.4); }
    .jn-mood-btn-circle { font-size:1.1rem; line-height:1; }
    .jn-mood-btn-label { font-size:.55rem; color:rgba(148,163,184,.32); font-weight:500; }
    .jn-mood-btn.selected .jn-mood-btn-label { color:rgba(34,197,94,.8); }

    /* Writing area */
    #jn-ed-content { width:100%; min-height:280px; padding:0; border:none; background:none; color:#e5e7eb; font-size:.95rem; font-family:inherit; resize:none; line-height:1.75; outline:none; caret-color:#22c55e; box-sizing:border-box; display:block; }
    #jn-ed-content::placeholder { color:rgba(148,163,184,.18); }

    /* AI Reflection button */
    .jn-reflect-btn { display:flex; align-items:center; gap:6px; padding:6px 12px; border-radius:8px; border:1px solid rgba(34,197,94,.3); background:rgba(34,197,94,.07); color:rgba(34,197,94,.75); font-size:.78rem; font-weight:500; cursor:pointer; font-family:inherit; margin-top:16px; transition:background .1s,color .1s,border-color .1s; }
    .jn-reflect-btn:hover:not(:disabled) { background:rgba(34,197,94,.14); color:#22c55e; border-color:rgba(34,197,94,.55); }
    .jn-reflect-btn:disabled { opacity:.35; cursor:default; }
    .jn-reflect-btn.loading { background:rgba(34,197,94,.05); }

    /* Reflection callout */
    .jn-reflection-callout { margin-top:16px; padding:14px 16px; border-radius:8px; background:rgba(34,197,94,.07); border-left:3px solid rgba(34,197,94,.5); }
    .jn-ref-top { display:flex; align-items:center; gap:6px; margin-bottom:10px; }
    .jn-ref-badge { font-size:.62rem; font-weight:700; text-transform:uppercase; letter-spacing:.1em; color:rgba(34,197,94,.7); flex:1; }
    .jn-ref-mood-tag { font-size:.7rem; background:rgba(34,197,94,.1); border:1px solid rgba(34,197,94,.3); border-radius:3px; padding:2px 7px; color:rgba(34,197,94,.9); }
    .jn-ref-divider { height:1px; background:rgba(34,197,94,.18); margin-bottom:10px; }
    .jn-ref-themes-row { display:flex; align-items:center; gap:5px; flex-wrap:wrap; margin-bottom:8px; }
    .jn-ref-themes-lbl { font-size:.58rem; font-weight:700; text-transform:uppercase; letter-spacing:.08em; color:rgba(148,163,184,.32); white-space:nowrap; }
    .jn-ref-theme-chip { font-size:.7rem; background:rgba(255,255,255,.06); border:1px solid rgba(255,255,255,.1); border-radius:3px; padding:1px 6px; color:rgba(148,163,184,.55); }
    .jn-ref-insight { margin-bottom:8px; }
    .jn-ref-insight-lbl { font-size:.58rem; font-weight:700; text-transform:uppercase; letter-spacing:.08em; color:rgba(148,163,184,.32); margin-bottom:3px; }
    .jn-ref-insight-text { font-size:.85rem; color:#e5e7eb; line-height:1.65; }
    .jn-ref-aff { padding:10px 12px; border-radius:6px; background:rgba(96,165,250,.06); border:1px solid rgba(96,165,250,.2); display:flex; gap:8px; }
    .jn-ref-aff-icon { color:rgba(96,165,250,.6); font-size:.85rem; flex-shrink:0; }
    .jn-ref-aff-text { font-size:.82rem; color:rgba(96,165,250,.85); line-height:1.55; font-style:italic; }

    /* Spinner */
    @keyframes jn-spin { to { transform:rotate(360deg); } }
    .jn-spinner { width:12px; height:12px; border:1.5px solid rgba(34,197,94,.2); border-top-color:#22c55e; border-radius:50%; animation:jn-spin .7s linear infinite; flex-shrink:0; }
    ...
    .jn-confirm-box { background:#0b1220; border:1px solid rgba(34,197,94,.25); border-radius:14px; padding:20px 22px; width:100%; max-width:320px; box-shadow:0 12px 40px rgba(0,0,0,.6); font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif; }
    .jn-confirm-title { font-size:.9rem; font-weight:600; color:#e5e7eb; margin-bottom:5px; }
    .jn-confirm-text { font-size:.78rem; color:rgba(148,163,184,.5); line-height:1.5; margin-bottom:16px; }
    .jn-confirm-btns { display:flex; gap:8px; justify-content:flex-end; }
    .jn-confirm-cancel { padding:6px 14px; border-radius:8px; border:1px solid rgba(255,255,255,.12); background:none; color:rgba(148,163,184,.5); cursor:pointer; font-size:.78rem; font-family:inherit; }
    .jn-confirm-cancel:hover { background:rgba(255,255,255,.06); }
    .jn-confirm-delete { padding:6px 14px; border-radius:8px; border:1px solid rgba(96,165,250,.3); background:rgba(96,165,250,.1); color:#60a5fa; cursor:pointer; font-size:.78rem; font-weight:700; font-family:inherit; }
    .jn-confirm-delete:hover { background:rgba(96,165,250,.18); }
    ...
    #jn-import-box { background:#0f172a; border:1px solid rgba(34,197,94,.2); border-radius:14px; box-shadow:0 16px 48px rgba(0,0,0,.6); width:100%; max-width:540px; max-height:90vh; overflow-y:auto; display:flex; flex-direction:column; font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Helvetica,Arial,sans-serif; }
    .jn-imp-bar { display:flex; align-items:center; gap:8px; padding:13px 16px; border-bottom:1px solid rgba(255,255,255,.07); position:sticky; top:0; background:#0f172a; z-index:1; }
    .jn-imp-title { flex:1; font-size:.82rem; font-weight:600; color:#e5e7eb; }
    .jn-imp-close { background:none; border:none; color:rgba(148,163,184,.4); font-size:1.1rem; cursor:pointer; padding:4px 7px; border-radius:4px; line-height:1; }
    .jn-imp-close:hover { background:rgba(255,255,255,.06); color:#e5e7eb; }
    .jn-imp-body { padding:14px 16px; display:flex; flex-direction:column; gap:12px; }
    .jn-imp-hint { font-size:.78rem; color:rgba(148,163,184,.5); line-height:1.6; }
    .jn-imp-hint strong { color:rgba(148,163,184,.75); font-weight:600; }
    .jn-imp-section-lbl { font-size:.62rem; font-weight:700; text-transform:uppercase; letter-spacing:.09em; color:rgba(34,197,94,.5); margin-bottom:5px; }
    .jn-imp-format-row { display:flex; gap:5px; flex-wrap:wrap; }
    .jn-imp-fmt-btn { padding:4px 10px; border-radius:6px; border:1px solid rgba(255,255,255,.1); background:none; color:rgba(148,163,184,.5); font-size:.72rem; font-weight:500; cursor:pointer; font-family:inherit; transition:all .1s; }
    .jn-imp-fmt-btn:hover { background:rgba(255,255,255,.05); }
    .jn-imp-fmt-btn.active { background:linear-gradient(135deg,#22c55e,#60a5fa); border-color:transparent; color:#fff; font-weight:700; }
    .jn-imp-upload-row { display:flex; align-items:center; gap:8px; }
    .jn-imp-file-label { display:flex; align-items:center; gap:5px; padding:6px 12px; border-radius:8px; border:1px solid rgba(34,197,94,.3); background:rgba(34,197,94,.07); color:rgba(34,197,94,.75); font-size:.75rem; cursor:pointer; white-space:nowrap; transition:background .1s; }
    .jn-imp-file-label:hover { background:rgba(34,197,94,.14); }
    #jn-imp-file { display:none; }
    .jn-imp-file-name { font-size:.7rem; color:rgba(148,163,184,.3); }
    ...
    #jn-imp-text { width:100%; min-height:130px; padding:9px 11px; border-radius:6px; border:1px solid rgba(255,255,255,.1); background:rgba(255,255,255,.03); color:#e5e7eb; font-size:.82rem; font-family:inherit; resize:vertical; line-height:1.6; outline:none; box-sizing:border-box; }
    #jn-imp-text:focus { border-color:rgba(34,197,94,.4); }
    #jn-imp-text::placeholder { color:rgba(148,163,184,.2); }
    .jn-imp-parse-btn { width:100%; padding:8px; border-radius:8px; border:1px solid rgba(34,197,94,.3); background:rgba(34,197,94,.08); color:rgba(34,197,94,.8); font-size:.8rem; font-weight:700; cursor:pointer; font-family:inherit; }
    .jn-imp-parse-btn:hover { background:rgba(34,197,94,.14); }
    #jn-imp-preview { display:none; }
    .jn-imp-preview-head { font-size:.75rem; font-weight:600; color:rgba(148,163,184,.55); margin-bottom:8px; }
    ...
    .jn-imp-prev-date { font-size:.7rem; font-weight:600; color:#e5e7eb; margin-bottom:2px; }
    .jn-imp-prev-text { font-size:.73rem; color:rgba(148,163,184,.42); display:-webkit-box; -webkit-line-clamp:2; -webkit-box-orient:vertical; overflow:hidden; }
    .jn-imp-prev-more { font-size:.7rem; color:rgba(148,163,184,.3); text-align:center; padding:4px; }
    .jn-imp-confirm-btn { width:100%; padding:9px; border-radius:8px; border:none; background:linear-gradient(135deg,#22c55e,#60a5fa); color:#fff; font-size:.82rem; font-weight:700; cursor:pointer; font-family:inherit; letter-spacing:.04em; }
  ...
  function renderTab() {
    ...
    tab.innerHTML = '<div class="jn-page">'
      ...
      + '</div>'
      + '<div class="jn-footer">Created with &#10084;&#65039; by <a href="https://github.com/tathagata1428/" target="_blank" rel="noopener">Bogdan Radu</a><span style="font-size:0.7em;opacity:0.5;margin-left:5px;">v2.2.5</span></div>'
      + '</div>';
