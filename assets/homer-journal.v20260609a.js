...
(function () {
  ...
  var CSS = `
    ...
    .jn-db-meta-dot { color:rgba(55,53,47,.2); }
    .jn-db-actions { display:flex; align-items:center; gap:6px; flex-shrink:0; padding-top:2px; }

    /* ── Buttons ─────────────────────────────────────────────────────*/
    .jn-btn-ghost { padding:5px 10px; border-radius:4px; border:none; background:none; color:rgba(55,53,47,.5); font-size:.75rem; cursor:pointer; font-family:inherit; display:flex; align-items:center; gap:4px; line-height:1.4; }
    .jn-btn-ghost:hover { background:rgba(55,53,47,.06); color:#37352f; }
    .jn-btn-primary { padding:5px 12px; border-radius:4px; border:none; background:#37352f; color:#fff; font-size:.75rem; font-weight:600; cursor:pointer; font-family:inherit; display:flex; align-items:center; gap:5px; line-height:1.4; }
    .jn-btn-primary:hover { background:#2f2d28; }

    /* ── Dividers ────────────────────────────────────────────────────*/
    .jn-section-div { height:1px; background:rgba(55,53,47,.06); }
    ...
    .jn-week-day:hover { background:rgba(55,53,47,.04); }
    .jn-week-lbl { font-size:.58rem; color:rgba(55,53,47,.38); text-transform:uppercase; letter-spacing:.05em; font-weight:600; }
    ...
    .jn-week-dot.has-entry { background:rgba(55,53,47,.06); }
    .jn-week-dot.is-today { outline:2px solid rgba(46,170,220,.4); outline-offset:1px; }
    .jn-week-dot.is-today.has-entry { background:rgba(46,170,220,.09); outline-color:#2eaadc; }
    .jn-week-empty { width:7px; height:7px; border-radius:50%; background:rgba(55,53,47,.1); }

    /* ── Prompt callout ──────────────────────────────────────────────*/
    .jn-callout { margin:10px 16px; border-radius:4px; background:rgba(46,170,220,.07); border-left:3px solid rgba(46,170,220,.5); padding:11px 14px; display:flex; align-items:flex-start; gap:10px; }
    .jn-callout-icon { font-size:1rem; flex-shrink:0; margin-top:2px; }
    .jn-callout-content { flex:1; min-width:0; }
    .jn-callout-lbl { font-size:.6rem; font-weight:700; text-transform:uppercase; letter-spacing:.1em; color:rgba(46,170,220,.65); margin-bottom:3px; }
    .jn-callout-text { font-size:.85rem; color:#37352f; line-height:1.5; margin-bottom:8px; font-style:italic; }
    .jn-callout-btn { padding:4px 10px; border-radius:4px; border:none; background:#2eaadc; color:#fff; font-size:.72rem; font-weight:600; cursor:pointer; font-family:inherit; }
    .jn-callout-btn:hover { background:#1a9cc8; }
    ...
    .jn-group-hd svg { color:rgba(55,53,47,.35); flex-shrink:0; }
    .jn-group-hd-text { font-size:.68rem; font-weight:600; color:rgba(55,53,47,.5); text-transform:uppercase; letter-spacing:.07em; }
    .jn-group-count { font-size:.65rem; color:rgba(55,53,47,.3); background:rgba(55,53,47,.05); border-radius:3px; padding:1px 5px; }
    ...
    .jn-row:hover { background:rgba(55,53,47,.03); }
    ...
    .jn-row-today-badge { font-size:.58rem; color:#2eaadc; background:rgba(46,170,220,.1); border-radius:3px; padding:1px 5px; font-weight:600; flex-shrink:0; }
    .jn-row-excerpt { font-size:.75rem; color:rgba(55,53,47,.4); white-space:nowrap; overflow:hidden; text-overflow:ellipsis; line-height:1.3; margin-top:1px; }
    .jn-row-props { display:flex; align-items:center; gap:4px; flex-shrink:0; }
    .jn-tag { font-size:.65rem; color:rgba(55,53,47,.45); background:rgba(55,53,47,.06); border-radius:3px; padding:2px 6px; white-space:nowrap; }
    .jn-tag.ai { background:rgba(46,170,220,.08); color:rgba(46,170,220,.65); }
    .jn-row-del { background:none; border:none; color:rgba(55,53,47,.2); cursor:pointer; font-size:.8rem; padding:3px 6px; border-radius:4px; opacity:0; transition:opacity .1s,color .1s,background .1s; line-height:1; flex-shrink:0; }
    .jn-row:hover .jn-row-del { opacity:1; }
    .jn-row-del:hover { color:#e03e3e; background:rgba(224,62,62,.08); }

    .jn-new-row { display:flex; align-items:center; gap:8px; padding:4px 14px 4px 16px; color:rgba(55,53,47,.3); font-size:.8rem; cursor:pointer; transition:background .08s; min-height:32px; margin-top:2px; }
    .jn-new-row:hover { background:rgba(55,53,47,.03); color:rgba(55,53,47,.5); }
    ...
    .jn-empty-title { font-size:.85rem; font-weight:600; color:rgba(55,53,47,.4); margin-bottom:5px; }
    .jn-empty-sub { font-size:.75rem; color:rgba(55,53,47,.3); }
    ...
    /* Top bar */
    .jn-ed-topbar { display:flex; align-items:center; gap:6px; padding:8px 16px; border-bottom:1px solid rgba(55,53,47,.06); position:sticky; top:0; background:rgba(255,255,255,.96); backdrop-filter:blur(4px); z-index:10; }
    ...
    .jn-ed-back:hover { background:rgba(55,53,47,.06); color:#37352f; }
    ...
    .jn-ed-del-btn:hover { color:#e03e3e; background:rgba(224,62,62,.06); }
    .jn-ed-save-btn { padding:5px 14px; border-radius:4px; border:none; background:#37352f; color:#fff; font-size:.75rem; font-weight:600; cursor:pointer; font-family:inherit; }
    .jn-ed-save-btn:hover { background:#2f2d28; }
    ...
    .jn-ed-date-display { font-size:1.75rem; font-weight:700; color:#37352f; line-height:1.2; letter-spacing:-.02em; cursor:pointer; padding:2px 0; border-radius:3px; display:inline-block; }
    .jn-ed-date-display:hover { background:rgba(55,53,47,.04); }
    #jn-ed-date-input { position:absolute; opacity:0; pointer-events:none; width:0; height:0; }
    .jn-ed-date-hint { font-size:.68rem; color:rgba(55,53,47,.33); margin-top:3px; }

    /* Properties panel */
    .jn-ed-props { border-bottom:1px solid rgba(55,53,47,.06); padding-bottom:14px; margin-bottom:18px; }
    .jn-prop-row { display:flex; align-items:flex-start; padding:3px 0; }
    .jn-prop-key { font-size:.75rem; color:rgba(55,53,47,.38); width:72px; flex-shrink:0; padding-top:6px; font-weight:500; }
    .jn-prop-val { flex:1; }

    /* Mood picker */
    .jn-mood-row { display:flex; gap:2px; flex-wrap:wrap; }
    .jn-mood-btn { display:flex; flex-direction:column; align-items:center; gap:2px; padding:4px 7px; border-radius:4px; cursor:pointer; border:1px solid transparent; transition:background .1s,border-color .1s; background:none; }
    .jn-mood-btn:hover { background:rgba(55,53,47,.05); }
    .jn-mood-btn.selected { background:rgba(55,53,47,.07); border-color:rgba(55,53,47,.12); }
    .jn-mood-btn-circle { font-size:1.1rem; line-height:1; }
    .jn-mood-btn-label { font-size:.55rem; color:rgba(55,53,47,.38); font-weight:500; }
    .jn-mood-btn.selected .jn-mood-btn-label { color:rgba(55,53,47,.6); }

    /* Writing area */
    #jn-ed-content { width:100%; min-height:280px; padding:0; border:none; background:none; color:#37352f; font-size:.95rem; font-family:inherit; resize:none; line-height:1.75; outline:none; caret-color:#37352f; box-sizing:border-box; display:block; }
    #jn-ed-content::placeholder { color:rgba(55,53,47,.22); }

    /* AI Reflection button */
    .jn-reflect-btn { display:flex; align-items:center; gap:6px; padding:6px 12px; border-radius:4px; border:1px solid rgba(55,53,47,.1); background:none; color:rgba(55,53,47,.45); font-size:.78rem; font-weight:500; cursor:pointer; font-family:inherit; margin-top:16px; transition:background .1s,color .1s,border-color .1s; }
    .jn-reflect-btn:hover:not(:disabled) { background:rgba(55,53,47,.04); color:#37352f; border-color:rgba(55,53,47,.18); }
    .jn-reflect-btn:disabled { opacity:.35; cursor:default; }
    .jn-reflect-btn.loading { background:rgba(55,53,47,.03); }

    /* Reflection callout */
    .jn-reflection-callout { margin-top:16px; padding:14px 16px; border-radius:4px; background:rgba(46,170,220,.06); border-left:3px solid rgba(46,170,220,.4); }
    .jn-ref-top { display:flex; align-items:center; gap:6px; margin-bottom:10px; }
    .jn-ref-badge { font-size:.62rem; font-weight:700; text-transform:uppercase; letter-spacing:.1em; color:rgba(46,170,220,.55); flex:1; }
    .jn-ref-mood-tag { font-size:.7rem; background:rgba(46,170,220,.08); border:1px solid rgba(46,170,220,.18); border-radius:3px; padding:2px 7px; color:rgba(46,170,220,.75); }
    .jn-ref-divider { height:1px; background:rgba(46,170,220,.12); margin-bottom:10px; }
    .jn-ref-themes-row { display:flex; align-items:center; gap:5px; flex-wrap:wrap; margin-bottom:8px; }
    .jn-ref-themes-lbl { font-size:.58rem; font-weight:700; text-transform:uppercase; letter-spacing:.08em; color:rgba(55,53,47,.33); white-space:nowrap; }
    .jn-ref-theme-chip { font-size:.7rem; background:rgba(55,53,47,.05); border:1px solid rgba(55,53,47,.09); border-radius:3px; padding:1px 6px; color:rgba(55,53,47,.5); }
    .jn-ref-insight { margin-bottom:8px; }
    .jn-ref-insight-lbl { font-size:.58rem; font-weight:700; text-transform:uppercase; letter-spacing:.08em; color:rgba(55,53,47,.33); margin-bottom:3px; }
    .jn-ref-insight-text { font-size:.85rem; color:#37352f; line-height:1.65; }
    .jn-ref-aff { padding:10px 12px; border-radius:3px; background:rgba(55,53,47,.03); border:1px solid rgba(55,53,47,.07); display:flex; gap:8px; }
    .jn-ref-aff-icon { color:rgba(55,53,47,.35); font-size:.85rem; flex-shrink:0; }
    .jn-ref-aff-text { font-size:.82rem; color:rgba(55,53,47,.6); line-height:1.55; font-style:italic; }

    /* Spinner */
    @keyframes jn-spin { to { transform:rotate(360deg); } }
    .jn-spinner { width:12px; height:12px; border:1.5px solid rgba(55,53,47,.14); border-top-color:rgba(55,53,47,.4); border-radius:50%; animation:jn-spin .7s linear infinite; flex-shrink:0; }

    /* Confirm dialog */
    .jn-confirm-overlay { position:fixed; inset:0; z-index:12000; background:rgba(55,53,47,.28); display:flex; align-items:center; justify-content:center; padding:20px; }
    .jn-confirm-box { background:#fff; border:1px solid rgba(55,53,47,.1); border-radius:8px; padding:20px 22px; width:100%; max-width:320px; box-shadow:0 8px 24px rgba(55,53,47,.1); font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif; }
    ...
    .jn-confirm-cancel { padding:6px 14px; border-radius:4px; border:1px solid rgba(55,53,47,.12); background:none; color:rgba(55,53,47,.5); cursor:pointer; font-size:.78rem; font-family:inherit; }
    .jn-confirm-cancel:hover { background:rgba(55,53,47,.04); }
    .jn-confirm-delete { padding:6px 14px; border-radius:4px; border:1px solid rgba(224,62,62,.2); background:rgba(224,62,62,.07); color:#e03e3e; cursor:pointer; font-size:.78rem; font-weight:600; font-family:inherit; }
    .jn-confirm-delete:hover { background:rgba(224,62,62,.12); }

    /* ── Import modal ────────────────────────────────────────────────*/
    #jn-import-overlay { position:fixed; inset:0; z-index:11000; background:rgba(55,53,47,.28); backdrop-filter:blur(3px); display:none; align-items:center; justify-content:center; padding:20px; }
    #jn-import-overlay.open { display:flex; }
    #jn-import-box { background:#fff; border-radius:8px; box-shadow:0 12px 40px rgba(55,53,47,.14); width:100%; max-width:540px; max-height:90vh; overflow-y:auto; display:flex; flex-direction:column; font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Helvetica,Arial,sans-serif; }
    .jn-imp-bar { display:flex; align-items:center; gap:8px; padding:13px 16px; border-bottom:1px solid rgba(55,53,47,.07); position:sticky; top:0; background:#fff; z-index:1; }
    ...
    .jn-imp-close:hover { background:rgba(55,53,47,.06); color:#37352f; }
    ...
    .jn-imp-hint strong { color:rgba(55,53,47,.7); font-weight:600; }
    .jn-imp-section-lbl { font-size:.62rem; font-weight:700; text-transform:uppercase; letter-spacing:.09em; color:rgba(55,53,47,.38); margin-bottom:5px; }
    .jn-imp-format-row { display:flex; gap:5px; flex-wrap:wrap; }
    .jn-imp-fmt-btn { padding:4px 10px; border-radius:4px; border:1px solid rgba(55,53,47,.12); background:none; color:rgba(55,53,47,.5); font-size:.72rem; font-weight:500; cursor:pointer; font-family:inherit; transition:all .1s; }
    .jn-imp-fmt-btn:hover { background:rgba(55,53,47,.04); }
    .jn-imp-fmt-btn.active { background:#37352f; border-color:#37352f; color:#fff; }
    .jn-imp-upload-row { display:flex; align-items:center; gap:8px; }
    .jn-imp-file-label { display:flex; align-items:center; gap:5px; padding:6px 12px; border-radius:4px; border:1px solid rgba(55,53,47,.12); background:none; color:rgba(55,53,47,.5); font-size:.75rem; cursor:pointer; white-space:nowrap; transition:background .1s; }
    .jn-imp-file-label:hover { background:rgba(55,53,47,.04); }
    #jn-imp-file { display:none; }
    .jn-imp-file-name { font-size:.7rem; color:rgba(55,53,47,.33); }
    .jn-imp-sep { display:flex; align-items:center; gap:8px; color:rgba(55,53,47,.28); font-size:.68rem; }
    .jn-imp-sep::before, .jn-imp-sep::after { content:''; flex:1; height:1px; background:rgba(55,53,47,.07); }
    #jn-imp-text { width:100%; min-height:130px; padding:9px 11px; border-radius:4px; border:1px solid rgba(55,53,47,.09); background:rgba(55,53,47,.02); color:#37352f; font-size:.82rem; font-family:inherit; resize:vertical; line-height:1.6; outline:none; box-sizing:border-box; }
    #jn-imp-text:focus { border-color:rgba(55,53,47,.22); }
    #jn-imp-text::placeholder { color:rgba(55,53,47,.22); }
    .jn-imp-parse-btn { width:100%; padding:8px; border-radius:4px; border:1px solid rgba(55,53,47,.1); background:rgba(55,53,47,.04); color:rgba(55,53,47,.65); font-size:.8rem; font-weight:600; cursor:pointer; font-family:inherit; }
    .jn-imp-parse-btn:hover { background:rgba(55,53,47,.07); }
    ...
    .jn-imp-prev-item { padding:7px 10px; border-radius:4px; background:rgba(55,53,47,.03); border:1px solid rgba(55,53,47,.06); }
    ...
    .jn-imp-prev-more { font-size:.7rem; color:rgba(55,53,47,.32); text-align:center; padding:4px; }
    .jn-imp-confirm-btn { width:100%; padding:9px; border-radius:4px; border:none; background:#37352f; color:#fff; font-size:.82rem; font-weight:600; cursor:pointer; font-family:inherit; }
    .jn-imp-confirm-btn:hover { background:#2f2d28; }
    .jn-imp-err { font-size:.75rem; color:#e03e3e; background:rgba(224,62,62,.06); border:1px solid rgba(224,62,62,.12); border-radius:4px; padding:8px 10px; }
    .jn-imp-success { font-size:.75rem; color:#0f7b6c; background:rgba(15,123,108,.06); border:1px solid rgba(15,123,108,.12); border-radius:4px; padding:8px 10px; }
  `;
