...
function renderQuote(q) {
  ...
  function applySavedQuoteMutation(request){
      ...
      if(op === 'clear'){
        saveSaved([]);
        renderSaved();
        return syncSavedQuotesToJoeyFile('saved-quotes-clear', { skipBackups:false }).then(function(ok){
      ...
      if(op === 'delete'){
        ...
        saveSaved(list);
        renderSaved();
        return syncSavedQuotesToJoeyFile('saved-quotes-delete', { skipBackups:false }).then(function(ok){
    ...
    function syncSavedQuotesNow(){
      ...
      return syncSavedQuotesToJoeyFile('saved-quotes-manual', { skipBackups:false }).then(function(ok){
        ...
        return Promise.resolve(
          (typeof window._homerBackupJoeyToDrive === 'function')
            ? window._homerBackupJoeyToDrive('saved-quotes-manual')
            : null
