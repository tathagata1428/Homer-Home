...
(function () {
  ...
  var CSS=[
    ...
    '.he-ledger-edit-btn:hover{color:#60a5fa}',
    ...
    '.he-budget-restore-lbl{font-size:.68rem;font-weight:800;color:#334155;text-transform:uppercase;letter-spacing:.08em;margin-bottom:6px;}',
