...
(function () {
  ...
  function toast(msg, type, dur) {
    ...
    el.style.cssText='position:fixed;bottom:80px;right:20px;z-index:99999;background:#180030;border:1px solid rgba(255,255,255,.15);color:#f0f0ff;padding:12px 16px;border-radius:12px;font-size:.88rem;font-weight:600;box-shadow:0 8px 32px rgba(0,0,0,.4);cursor:pointer;max-width:320px;';
    el.textContent=msg;
  ...
  var CSS=[
    ...
    'body.theme-light{--bg:#0d0020!important;--text:#f0f0ff!important;--muted:#9090b8!important;--card-a:rgba(255,255,255,.04)!important;--card-b:rgba(255,255,255,.02)!important;background:#0d0020!important;color:#f0f0ff!important;}',
    ...
    '#he-fab-more:hover{background:rgba(255,255,255,.1)!important;color:#9090b8!important;}',
    ...
    '.he-sb-capture{color:#FF0066!important;}',
    '.he-sb-capture:hover{background:rgba(255,0,102,.1)!important;}',
    ...
    '#he-cmd-box{background:#0d0020;border:1px solid rgba(255,255,255,.18);border-radius:18px;width:100%;max-width:560px;margin:0 16px;box-shadow:0 32px 80px rgba(0,0,0,.75);overflow:hidden;transform:translateY(-8px);transition:transform .15s}',
    '#he-cmd-overlay.open #he-cmd-box{transform:translateY(0)}',
    '#he-cmd-input{width:100%;padding:16px 20px;background:none;border:none;outline:none;color:#f0f0ff;font-size:1rem;font-family:inherit;border-bottom:1px solid rgba(255,255,255,.08);box-sizing:border-box}',
    ...
    '.he-cmd-item{display:flex;align-items:center;gap:12px;padding:9px 12px;border-radius:10px;cursor:pointer;transition:background .08s;color:#f0f0ff;font-size:.9rem;font-weight:600;user-select:none}',
    '.he-cmd-item.active,.he-cmd-item:hover{background:rgba(255,0,102,.15)}',
    ...
    '#he-keys-box{background:#0d0020;border:1px solid rgba(255,255,255,.15);border-radius:20px;padding:28px 32px;max-width:500px;width:calc(100% - 32px);box-shadow:0 24px 64px rgba(0,0,0,.6);max-height:85vh;overflow-y:auto}',
    '#he-keys-box h2{font-size:.95rem;font-weight:800;color:#f0f0ff;margin:0 0 18px;text-align:center;text-transform:uppercase;letter-spacing:.04em}',
    ...
    '.he-kbd{display:inline-block;padding:3px 8px;border-radius:6px;border:1px solid rgba(255,255,255,.18);background:rgba(255,255,255,.07);color:#9090b8;font-size:.72rem;font-weight:700;font-family:monospace;line-height:1.5}',
    '#he-keys-close-btn{display:block;width:100%;margin-top:18px;padding:9px;border-radius:10px;border:1px solid rgba(255,255,255,.1);background:rgba(255,255,255,.04);color:#9090b8;font-size:.82rem;font-weight:700;cursor:pointer}',
    ...
    '#he-links-search{width:100%;padding:10px 14px;border-radius:10px;border:1px solid rgba(255,255,255,.18);background:#100020;color:var(--text);font-size:.9rem;font-family:inherit;outline:none;box-sizing:border-box;transition:border-color .2s}',
    '#he-links-search:focus{border-color:rgba(255,0,102,.5)}',
    ...
    '.he-bar-label{width:80px;font-size:.7rem;color:#9090b8;font-weight:700;text-align:right;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;flex-shrink:0}',
    ...
    '.he-bar-val{width:66px;font-size:.7rem;color:#9090b8;font-weight:700;text-align:right;white-space:nowrap;flex-shrink:0}',

    /* Supabase sync badge */
    '#he-sync-badge{position:fixed;bottom:16px;right:16px;z-index:9988;font-size:.68rem;font-weight:700;color:#64748b;background:rgba(13,0,32,.85);border:1px solid rgba(255,255,255,.08);border-radius:20px;padding:3px 10px;pointer-events:none;opacity:0;transition:opacity .3s;white-space:nowrap}',
    '#he-sync-badge.visible{opacity:1}',
    '#he-sync-badge.syncing{color:#FF0066}',
    ...
    '#he-ledger-topbar h2{margin:0;font-size:1.1rem;font-weight:800;color:#f0f0ff}',
    '#he-ledger-close{padding:7px 16px;border-radius:10px;border:1px solid rgba(255,255,255,.14);background:none;color:#9090b8;font-size:.85rem;font-weight:700;cursor:pointer}',
    ...
    '.he-ledger-input{padding:8px 12px;border-radius:9px;border:1px solid rgba(255,255,255,.12);background:rgba(255,255,255,.05);color:#f0f0ff;font-size:.88rem;font-family:inherit;outline:none}',
    '.he-ledger-input:focus{border-color:rgba(255,0,102,.4)}',
    ...
    '.he-ledger-add-btn{padding:8px 18px;border-radius:9px;border:none;background:#FF3380;color:#fff;font-size:.85rem;font-weight:700;cursor:pointer;white-space:nowrap;flex-shrink:0}',
    ...
    '.he-ledger-stat-val{font-size:1.3rem;font-weight:900;color:#f0f0ff}',
    ...
    '.he-ledger-filter{padding:7px 12px;border-radius:9px;border:1px solid rgba(255,255,255,.12);background:rgba(255,255,255,.04);color:#f0f0ff;font-size:.85rem;font-family:inherit;outline:none;cursor:pointer}',
    ...
    '#he-ledger-table th:hover{color:#9090b8}',
    '.he-th-arrow{margin-left:4px;opacity:.5}',
    '#he-ledger-table td{padding:10px 14px;border-bottom:1px solid rgba(255,255,255,.05);color:#f0f0ff;vertical-align:middle}',
    ...
    '.he-ledger-edit-btn:hover{color:#FF0066}',
    ...
    /* Session log badge */
    '#he-session-log{position:fixed;bottom:16px;left:16px;z-index:9990;background:rgba(13,0,32,.9);border:1px solid rgba(255,255,255,.1);border-radius:12px;padding:6px 12px;font-size:.72rem;color:#9090b8;font-weight:700;opacity:0;pointer-events:none;transition:opacity .3s;white-space:nowrap}',
    ...
    '.he-iab-links{border-color:rgba(255,0,102,.35);color:#FF0066;background:rgba(255,0,102,.07);}',
    '.he-iab-links:hover{background:rgba(255,0,102,.18);}',
    ...
    '#he-wx-toggle-btn{margin-top:10px;background:none;border:1px solid rgba(255,0,102,.22);color:#FF0066;font-size:.72rem;font-weight:700;padding:4px 12px;border-radius:20px;cursor:pointer;transition:background .15s;font-family:inherit;}',
    '#he-wx-toggle-btn:hover{background:rgba(255,0,102,.1);}',
    ...
    '.he-wx-day-name{width:40px;font-size:.72rem;color:#9090b8;font-weight:700;flex-shrink:0;}',
    ...
    '.he-wx-day-temp{font-size:.75rem;font-weight:800;color:#f0f0ff;white-space:nowrap;}',
    '.he-wx-day-lo{font-weight:400;color:#64748b;}',
    '.he-wx-city{font-size:.68rem;color:#FF0066;font-weight:700;margin-bottom:8px;letter-spacing:.03em;}',
    ...
    '.he-insight-val{font-size:1.1rem;font-weight:900;color:#f0f0ff;line-height:1.2;}',
    ...
    '.he-budget-edit-btn:hover{color:#9090b8;background:rgba(255,255,255,.06);}',
    '.he-budget-rm-btn{background:none;border:none;color:#280050;cursor:pointer;font-size:.72rem;padding:1px 4px;border-radius:5px;transition:color .15s;line-height:1;}',
    '.he-budget-rm-btn:hover{color:#f87171;}',
    '.he-budget-restore{margin-top:10px;padding-top:10px;border-top:1px solid rgba(255,255,255,.06);}',
    '.he-budget-restore-lbl{font-size:.68rem;font-weight:800;color:#280050;text-transform:uppercase;letter-spacing:.08em;margin-bottom:6px;}',
    '.he-budget-restore-chip{display:inline-flex;align-items:center;gap:4px;padding:3px 9px;border-radius:20px;border:1px solid rgba(255,255,255,.1);background:rgba(255,255,255,.03);color:#64748b;font-size:.72rem;cursor:pointer;margin:2px 3px;transition:border-color .15s,color .15s;}',
    '.he-budget-restore-chip:hover{border-color:rgba(52,211,153,.35);color:#34d399;}',

    /* Export button + notes */
    '#he-ledger-export{padding:7px 14px;border-radius:9px;border:1px solid rgba(255,255,255,.1);background:rgba(255,255,255,.04);color:#9090b8;font-size:.8rem;font-weight:700;cursor:pointer;white-space:nowrap;}',
    ...
    '.he-lnav-btn.active{color:#f0f0ff;border-bottom-color:#FF3380;}',
    '.he-lnav-btn:hover:not(.active){color:#9090b8;}',
    ...
    '.he-tpl-chip{display:inline-flex;align-items:center;gap:4px;padding:4px 10px;border-radius:20px;border:1px solid rgba(255,255,255,.1);background:rgba(255,255,255,.04);font-size:.72rem;font-weight:700;color:#9090b8;cursor:pointer;transition:all .15s;user-select:none;}',
    '.he-tpl-chip:hover{border-color:rgba(255,0,102,.4);color:#FF0066;background:rgba(255,0,102,.07);}',
    ...
    '.he-tpl-save:hover{border-color:rgba(255,255,255,.2);color:#9090b8;}',
    ...
    '.he-cat-chip-lbl:hover{border-color:rgba(255,255,255,.22);color:#9090b8;}',
    ...
    '.he-payday-days{font-size:2.2rem;font-weight:900;color:#f0f0ff;line-height:1;min-width:50px;}',
    '.he-payday-meta{font-size:.78rem;color:#64748b;line-height:1.6;}',
    '.he-payday-meta strong{color:#f0f0ff;}',
    ...
    '.he-goal-name{font-weight:800;color:#f0f0ff;font-size:.9rem;flex:1;}',
    ...
    '.he-goal-meta-pct{font-weight:800;color:#f0f0ff;}',
    ...
    '.he-mo-bar-val{font-size:.58rem;color:#9090b8;white-space:nowrap;}',
    ...
    (function tryAttach(){
      ...
      function showLocPrompt(){
        ...
        forecastDiv.innerHTML=
          '<div style="text-align:center;padding:10px 0;">'+
            '<p style="font-size:.78rem;color:#9090b8;margin:0 0 10px;line-height:1.4">Use your location for accurate weather?</p>'+
            '<button id="he-wx-allow" style="padding:5px 14px;border-radius:8px;border:none;background:#FF3380;color:#fff;font-size:.75rem;font-weight:700;cursor:pointer;margin-right:6px">&#x1F4CD; My Location</button>'+
            '<button id="he-wx-skip" style="padding:5px 14px;border-radius:8px;border:1px solid rgba(255,255,255,.12);background:none;color:#9090b8;font-size:.75rem;cursor:pointer">Bucharest</button>'+
          '</div>';
      ...
      function renderForecast(d){
        ...
        daily.time.forEach(function(dateStr,i){
          ...
          var extras='';
          if(precip&&precip>0.5)extras+=' <span style="font-size:.65rem;color:#FF0066">\uD83D\uDCA7 '+precip.toFixed(1)+'mm</span>';
          if(wind&&wind>20)extras+=' <span style="font-size:.65rem;color:#9090b8">\uD83D\uDCA8 '+Math.round(wind)+'km/h</span>';
  ...
  function initExpenseChart(){
    var CC={food:'#fb7185',transport:'#fbbf24',work:'#FF0066',health:'#34d399',entertainment:'#a78bfa',other:'#9090b8'};
    ...
    function renderChart(){
      ...
      el.innerHTML=cats.map(function(c){var p=max>0?(totals[c]/max*100).toFixed(1):0;return'<div class="he-bar-row"><div class="he-bar-label">'+esc(CL[c]||c)+'</div><div class="he-bar-track"><div class="he-bar-fill" style="width:'+p+'%;background:'+(CC[c]||'#9090b8')+'"></div></div><div class="he-bar-val">'+totals[c].toFixed(0)+' RON</div></div>';}).join('');
    }
  }
        ...
        function applyMerge(remoteKanban,remoteLg){
          ...
          vault.projects=mergedKanban.projects.map(function(p){
            ...
            return{id:p.id,name:p.name,key:p.key,description:p.description||'',icon:p.icon||'',
              color:p.color||'#FF3380',customFields:customFields,
  ...
  var CAT_COLOR={groceries:'#CC00FF',restaurants:'#fb923c',coffee:'#b45309',food:'#fb7185',rent:'#6366f1',home:'#14b8a6',transport:'#fbbf24',utilities:'#eab308',insurance:'#64748b',health:'#34d399',fitness:'#ef4444',work:'#FF0066',education:'#f97316',shopping:'#f472b6',travel:'#38bdf8',personal:'#e879f9',subscriptions:'#818cf8',entertainment:'#a78bfa',savings:'#0ea5e9',gifts:'#fdba74',other:'#9090b8'};
  ...
  function getCatColor(c){if(CAT_COLOR[c])return CAT_COLOR[c];var cc=getCustomCats().find(function(x){return x.name===c;});return cc?(cc.color||'#9090b8'):'#9090b8';}
  ...
  var GOAL_COLORS=['#FF3380','#34d399','#f87171','#fbbf24','#a78bfa','#fb7185','#FF0066'];
  ...
  function showDeleteCatModal(cat,allExpenses,onDone){
    ...
    var body=inCat.length>0?
      '<div style="font-size:1rem;font-weight:700;color:#f0f0ff;margin-bottom:8px;">'+getCatIcon(cat)+' '+esc(getCatLabel(cat))+' has transactions</div>'+
      '<div style="font-size:.83rem;color:#9090b8;margin-bottom:16px;line-height:1.5">'+inCat.length+' transaction'+(inCat.length!==1?'s':'')+' — <b style="color:#f87171;">'+total.toFixed(0)+' RON</b>. Move them to another category:</div>'+
      '<select id="he-del-to" style="width:100%;padding:9px 12px;background:#0d0020;border:1px solid rgba(255,255,255,.12);border-radius:8px;color:#f0f0ff;font-size:.83rem;margin-bottom:16px;">'+
      ...
      '<button id="he-del-cancel" style="flex:1;padding:10px;background:rgba(255,255,255,.07);border:none;border-radius:10px;color:#9090b8;cursor:pointer;font-size:.84rem;">Cancel</button></div>'
      :
      '<div style="font-size:1rem;font-weight:700;color:#f0f0ff;margin-bottom:8px;">Delete '+getCatIcon(cat)+' '+esc(getCatLabel(cat))+'?</div>'+
      '<div style="font-size:.83rem;color:#9090b8;margin-bottom:20px;">No transactions in this category.</div>'+
      ...
      '<button id="he-del-cancel" style="flex:1;padding:10px;background:rgba(255,255,255,.07);border:none;border-radius:10px;color:#9090b8;cursor:pointer;font-size:.84rem;">Cancel</button></div>';
    modal.innerHTML='<div style="background:#180030;border-radius:16px;padding:24px;max-width:400px;width:100%;border:1px solid rgba(255,255,255,.12);">'+body+'</div>';
  ...
  function renderOverview(view){
    ...
    if(pd>0){
      ...
      html+='<div style="font-size:.78rem;color:#475569;padding:2px 0;">'+
        '&#x1F4C5; <button id="he-payday-set" style="background:none;border:none;color:#FF0066;cursor:pointer;font-size:.78rem;font-family:inherit;font-weight:700;">Set payday date</button> for a countdown</div>';
    }
    ...
    if(!recent.length){
      ...
      html+=recent.map(function(e){
        ...
        return'<div style="display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid rgba(255,255,255,.05);">'+
          ...
          '<span style="font-weight:800;color:#f0f0ff;font-size:.88rem;">'+parseFloat(e.amount||0).toFixed(2)+' RON</span>'+
        '</div>';
      }).join('');
    }
    html+='</div>';
  ...
  function buildCatChips(){
    ...
    return'<div class="he-cat-chips-wrap" id="he-l-cat-chips">'+
      ...
      '<span class="he-cat-chip-lbl" id="he-cat-new-chip" style="border-style:dashed;color:#FF0066;border-color:rgba(255,0,102,.3);">&#xFF0B; New</span>'+
    '</div>'+
  ...
  function renderGoalsView(view){
    ...
    if(!gs.length){
      ...
      html+=gs.map(function(g,i){
        ...
        return'<div class="he-goal-card">'+
          '<div class="he-goal-header"><div class="he-goal-dot" style="background:'+esc(g.color||'#FF3380')+'"></div><div class="he-goal-name">'+esc(g.name||'Goal')+'</div><button class="he-goal-del" data-di="'+i+'">&#xD7;</button></div>'+
          '<div class="he-goal-bar-track"><div class="he-goal-bar-fill" style="width:'+pct.toFixed(1)+'%;background:'+esc(g.color||'#FF3380')+'"></div></div>'+
    ...
    document.getElementById('he-goal-add-btn').addEventListener('click',function(){
      ...
      var color=(document.getElementById('he-goal-color')||{}).value||'#FF3380';
  ...
  function renderReports(view){
    ...
    var burnCol=burnPct>=100?'#ef4444':burnPct>=80?'#f97316':burnPct>=60?'#fbbf24':'#CC00FF';
  ...
  function renderCalendarHeatmap(expenses){
    ...
    for(var d=1;d<=dim;d++){
      ...
      html+='<div class="he-cal-dc he-cx'+ix+'" title="'+d+': '+amt.toFixed(0)+' RON"'+(isToday?' style="outline:2px solid #FF3380;outline-offset:1px;"':'')+'>'+d+'</div>';
    }
    el.innerHTML=html;
  }
  ...
  function renderBudgets(allExpenses, filterEmpty){
    ...
    var rows=visibleCats.map(function(cat){
      ...
      var barCol=rawPct>=100?'#ef4444':rawPct>=90?'#f97316':rawPct>=70?'#fbbf24':'#CC00FF';
      ...
      btn.addEventListener('click',function(){
        ...
        infoSpan.outerHTML=
          '<div class="he-budget-inline-edit" style="display:flex;align-items:center;gap:4px;flex-shrink:0;">'+
            ...
            '<button class="he-be-ok" style="background:#FF3380;border:none;color:#fff;cursor:pointer;font-size:.76rem;padding:3px 10px;border-radius:6px;font-weight:700;">&#x2713;</button>'+
  ...
  function renderLedgerInbox(){
    ...
    var TC={thought:'#a78bfa',task:'#34d399',link:'#FF0066',expense:'#fbbf24'};
    var today=new Date().toISOString().slice(0,10);
    var cats=getAllCats();
    ...
    el.innerHTML=inbox.map(function(item,i){
      var tc=TC[item.type||'thought']||'#9090b8';
      var text=item.text||'';
      ...
      return'<div class="he-inbox-item" data-idx="'+i+'">'+
        ...
        '<div class="he-inbox-form" style="display:none">'+
          ...
          '<div class="he-inbox-form-row">'+
            ...
            '<button class="he-ibox-save" style="padding:6px 14px;background:#CC00FF;border:none;border-radius:9px;color:#fff;font-weight:700;cursor:pointer;font-size:.82rem;white-space:nowrap;">&#x2713; Add Expense</button>'+
    ...
    (function(){
      ...
      function populatePicker(linkedIds){
        ...
        habits.forEach(function(h){
          ...
          html+='<input type="checkbox" value="'+h.id+'" '+chk+' style="accent-color:#FF0066;cursor:pointer;"> ';
          ...
          window._homerLoadVault().then(function(data){
            ...
            lgGrid.querySelectorAll('.lg-card').forEach(function(card){
              ...
              linked.forEach(function(h){
                ...
                var color=pct>=70?'#dd44ff':pct>=40?'#fbbf24':'#f87171';
                var chip=document.createElement('span');
                chip.style.cssText='display:inline-flex;align-items:center;gap:4px;padding:3px 8px;border-radius:12px;font-size:.72rem;background:rgba(255,0,102,.08);border:1px solid rgba(255,0,102,.25);color:#FF88AA;';
