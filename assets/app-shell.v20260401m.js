...
(function(){
  ...
  function syncVoiceUi(){
    ...
    voiceBtn.classList.toggle('active', supported && !listening);
    ...
    voiceBtn.title = !supported
      ? 'Voice input requires Chrome or Edge on HTTPS'
      : (listening ? 'Stop voice recording' : 'Start voice recording');
  }
  ...
  function startVoiceInput(){
    if(!SpeechRecognitionCtor){
      setUploadStatus('Voice input requires Chrome or Edge on HTTPS.', 'warn', true);
      syncVoiceUi();
      return;
    }
    if(streaming){
