...
(function(){
  ...
  function syncVoiceUi(){
    if(!voiceBtn) return;
    var supported = !!isIosVoiceFallbackPreferred() || !!((navigator.mediaDevices && navigator.mediaDevices.getUserMedia && MediaRecorderCtor) || SpeechRecognitionCtor);
  ...
  function startVoiceInput(){
    if(isIosVoiceFallbackPreferred()){
