...
(function () {
  ...
  var CSS = `
    ...
    .car-title-main { font-size:1.5rem; font-weight:900; letter-spacing:.04em; color:#f0f0ff; line-height:1.1; }
    .car-title-sub  { font-size:1.5rem; font-weight:900; letter-spacing:.04em; color:#FF0066; line-height:1.1; }
    .car-title-bar  { width:40px; height:2px; background:linear-gradient(90deg,#FF0066,#FF3380); margin-top:6px; border-radius:1px; }
    .car-add-btn { display:flex; align-items:center; gap:6px; padding:9px 16px; border-radius:12px; border:none; background:linear-gradient(135deg,#FF3380,#CC0055); color:#fff; font-size:.82rem; font-weight:700; cursor:pointer; flex-shrink:0; }
    .car-add-btn:hover { filter:brightness(1.12); }
    .car-sync-btn { padding:7px 10px; border-radius:10px; border:1px solid rgba(255,0,102,.35); background:rgba(255,0,102,.1); color:#FF0066; font-size:1.05rem; cursor:pointer; flex-shrink:0; margin-right:6px; transition:background .2s; }
    .car-sync-btn:hover { background:rgba(255,0,102,.22); }
    ...
    .car-icon-box { width:52px;height:52px;border-radius:14px;background:rgba(255,0,102,.1);border:1px solid rgba(255,0,102,.2);display:flex;align-items:center;justify-content:center;font-size:1.5rem;flex-shrink:0; }
    .car-vc-name { font-size:1.35rem; font-weight:800; color:#f0f0ff; line-height:1.1; }
    .car-vc-meta { font-size:.82rem; color:#FF0066; font-weight:600; margin-top:3px; display:flex; gap:8px; align-items:center; }
    .car-plate { margin-left:auto; background:rgba(255,0,102,.1); border:1px solid rgba(255,0,102,.3); border-radius:8px; padding:5px 11px; font-size:.88rem; font-weight:800; color:#FF88AA; letter-spacing:.1em; white-space:nowrap; }
    ...
    .car-vin-val { font-size:.78rem; color:#9090b8; font-family:monospace; letter-spacing:.04em; }
    ...
    .car-v-pill.active { background:rgba(255,0,102,.12); border-color:rgba(255,0,102,.4); color:#FF0066; font-weight:700; }
    ...
    .car-add-doc   { border-color:rgba(255,0,102,.35); color:#FF0066; }
    ...
    .car-modal { background:#0d0020; border:1px solid rgba(255,255,255,.12); border-radius:20px 20px 0 0; padding:20px 20px 32px; width:100%; max-width:560px; max-height:92vh; overflow-y:auto; position:relative; }
    ...
    .car-modal-title { font-size:1rem; font-weight:800; color:#f0f0ff; margin-bottom:18px; }
    ...
    .car-field label { font-size:.7rem; font-weight:700; text-transform:uppercase; letter-spacing:.05em; color:#9090b8; }
    ...
    .car-field input:focus, .car-field textarea:focus, .car-field select:focus {
      border-color:rgba(255,0,102,.5); background:rgba(255,0,102,.04);
    }
    .car-field select option { background:#0d0020; }
    ...
    .car-modal-save { padding:10px 24px; border-radius:10px; border:none; background:linear-gradient(135deg,#FF3380,#CC0055); color:#fff; font-size:.85rem; font-weight:700; cursor:pointer; }
    ...
    .car-modal-cancel:hover { color:#9090b8; }
    ...
    .car-checkbox-row { display:flex; align-items:center; gap:8px; margin-bottom:10px; font-size:.85rem; color:#9090b8; cursor:pointer; }
    .car-checkbox-row input { width:auto; }

    /* File attachment */
    .car-file-zone { border:1px dashed rgba(255,0,102,.3); border-radius:10px; padding:16px; text-align:center; cursor:pointer; color:#64748b; font-size:.82rem; transition:all .15s; margin-top:4px; }
    .car-file-zone:hover { border-color:rgba(255,0,102,.6); color:#9090b8; background:rgba(255,0,102,.03); }
    .car-file-zone.has-file { border-color:rgba(52,211,153,.45); background:rgba(52,211,153,.04); color:#f0f0ff; }
    .car-file-btn { background:none; border:1px solid rgba(255,0,102,.25); border-radius:6px; color:#FF0066; font-size:.72rem; padding:2px 7px; cursor:pointer; flex-shrink:0; }
    .car-file-btn:hover { background:rgba(255,0,102,.08); }
  ...
  function buildVehicleCard(v) {
    ...
    if (v.purchaseDate) stats.push({ icon:'📅', label:'PURCHASED',   value: fmtDate(v.purchaseDate), color:'#9090b8' });
    ...
    html += '<button style="flex:1;padding:7px;border-radius:8px;border:1px solid rgba(255,255,255,.1);background:none;color:#9090b8;font-size:.78rem;cursor:pointer;" id="car-edit-vehicle-btn">✏️ Edit</button>';
  ...
  function buildFuelTab(vehicle) {
    ...
    if (odoLogs.length > 0) {
      odoLogs.forEach(function(o) {
        ...
        html += '<span style="color:#f0f0ff;font-weight:700;font-size:.85rem;">' + fmtDate(o.date) + '</span>';
