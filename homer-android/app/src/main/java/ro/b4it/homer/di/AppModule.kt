...
private val MIGRATION_8_9 = object : Migration(8, 9) {
    override fun migrate(db: SupportSQLiteDatabase) {
        db.execSQL("ALTER TABLE kanban_tasks ADD COLUMN linkedHabitId TEXT NOT NULL DEFAULT ''")
        db.execSQL("ALTER TABLE habits ADD COLUMN linkedTaskId TEXT NOT NULL DEFAULT ''")
    }
}
